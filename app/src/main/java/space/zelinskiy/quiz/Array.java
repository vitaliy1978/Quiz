...
public class Array {
    ...
    final int[] images1 = {
            R.drawable.onelevel0,
            R.drawable.onelevel1,
            R.drawable.onelevel2,
            R.drawable.onelevel3,
            R.drawable.onelevel4,
            R.drawable.onelevel5,
            R.drawable.onelevel6,
            R.drawable.onelevel7,
            R.drawable.onelevel8,
            R.drawable.onelevel9,
    };
    final int[] texts1 ={
            R.string.lvl1text0,
            R.string.lvl1text1,
    ...
    final int[] images2 = {
            R.drawable.twolevel1,
            R.drawable.twolevel2,
            R.drawable.twolevel3,
            R.drawable.twolevel4,
            R.drawable.twolevel5,
            R.drawable.twolevel6,
            R.drawable.twolevel7,
            R.drawable.twolevel8,
            R.drawable.twolevel9,
            R.drawable.twolevel10,
    };
    final int[] texts2 ={
            R.string.lvl2text1,
            R.string.lvl2text2,
        ...
        final int[] images3 = {
                ...
                R.drawable.threelevel_o,
                R.drawable.threelevel_p,
                R.drawable.threelevel_q,
                R.drawable.threelevel_r,
                R.drawable.threelevel_s,
                R.drawable.threelevel_t,
                R.drawable.threelevel_u,
                R.drawable.threelevel_v,
                R.drawable.threelevel_w,
                R.drawable.threelevel_x,
                R.drawable.threelevel_y,
                R.drawable.threelevel_z,
        };
    final int[] texts3 ={
            R.string.lvl3textA,
            R.string.lvl3textB,
