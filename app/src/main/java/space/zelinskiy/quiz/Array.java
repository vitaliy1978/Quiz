...
//    //Массив для первого уровня - Конец
    ...
    //Массив для русских букв - Начало
    final int[] images2ru = {
            R.drawable.threelevel_1, R.drawable.threelevel_2, R.drawable.threelevel_3, R.drawable.threelevel_4,
            R.drawable.threelevel_5, R.drawable.threelevel_6, R.drawable.threelevel_7, R.drawable.threelevel_8,
            R.drawable.threelevel_9, R.drawable.threelevel_10, R.drawable.threelevel_11, R.drawable.threelevel_12,
            R.drawable.threelevel_13, R.drawable.threelevel_14, R.drawable.threelevel_15, R.drawable.threelevel_16,
            R.drawable.threelevel_17, R.drawable.threelevel_18, R.drawable.threelevel_19, R.drawable.threelevel_20,
            R.drawable.threelevel_21, R.drawable.threelevel_22, R.drawable.threelevel_23, R.drawable.threelevel_24,
            R.drawable.threelevel_25, R.drawable.threelevel_26, R.drawable.threelevel_27, R.drawable.threelevel_28,
            R.drawable.threelevel_29, R.drawable.threelevel_30, R.drawable.threelevel_31, R.drawable.threelevel_32,
            R.drawable.threelevel_33,
    };
    final int[] texts2ru ={
            R.string.lvl3textru1, R.string.lvl3textru2, R.string.lvl3textru3, R.string.lvl3textru4, R.string.lvl3textru5,
            R.string.lvl3textru6, R.string.lvl3textru7, R.string.lvl3textru8, R.string.lvl3textru9, R.string.lvl3textru10,
            R.string.lvl3textru11, R.string.lvl3textru12, R.string.lvl3textru13, R.string.lvl3textru14, R.string.lvl3textru15,
            R.string.lvl3textru16, R.string.lvl3textru17, R.string.lvl3textru18, R.string.lvl3textru19, R.string.lvl3textru20,
            R.string.lvl3textru21, R.string.lvl3textru22, R.string.lvl3textru23, R.string.lvl3textru24, R.string.lvl3textru25,
            R.string.lvl3textru26, R.string.lvl3textru27, R.string.lvl3textru28, R.string.lvl3textru29, R.string.lvl3textru30,
            R.string.lvl3textru31, R.string.lvl3textru32, R.string.lvl3textru33,
    };
    //Массив для русских букв - Конец
