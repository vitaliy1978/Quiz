...
public class GameLevels extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       textView1.setOnClickListener(new View.OnClickListener() {
        ...
        //кнопка для перехона 15-й уровень - Конец
        //кнопка для перехона 16-й уровень - Начало
        ...
        //кнопка для перехона 16-й уровень - Конец
        ...
        final int[] count={R.id.textViewlock1,R.id.textViewlock2,R.id.textViewlock3,R.id.textViewlock4,R.id.textViewlock5,R.id.textViewlock6,
                ...
                R.id.textViewlock14,R.id.textViewlock15,R.id.textViewlock16,R.id.textViewlock17};
